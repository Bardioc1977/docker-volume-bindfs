...
# enable the plugin
sudo docker plugin enable Bardioc1977/docker-volume-bindfs:$TAG
# list plugins
sudo docker plugin ls

# test1: simple
sudo docker volume create -d Bardioc1977/docker-volume-bindfs:$TAG -o sourcePath=/tmp/test123 -o map=$TESTUSERID/0:@$TESTUSERID/@0 bindfsvolume

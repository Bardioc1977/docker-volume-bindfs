...
# enable the plugin
sudo docker plugin enable bardioc/bindfs:$TAG
# list plugins
sudo docker plugin ls

# test1: simple
sudo docker volume create -d bardioc/bindfs:$TAG -o sourcePath=/tmp/test123 -o map=$TESTUSERID/0:@$TESTUSERID/@0 bindfsvolume
